...
namespace cnc {
	...
	public:
		...
		void OffsetsBasedCFSLinking(std::string path, bool re_running, bool magic_nbumber=true);
		...
		*****************************************************************************************************************/
		...
		void Output_tree(int nodes_nb, std::vector<int> &edges, std::string path);
		...
		void OutputOffsets(const std::string path, const Vector3d1 &offset);
		void OutputOffsets1(const std::string path, const Vector3d1 &offset);
		void OutputOffsets(const std::string path, const Vector3d2 &offsets, bool name_b = true);
		void OutputStrips(const std::string path, const Vector3d2 &offsets, bool name_b = true);
		...
		void OutputOffsetsFiles(std::vector<string> &offsets_files, std::string path);
		...
		void BuildOffsets(Vector3d2 &input_boundaries, Vector3d3 &offsetses, Vector3d2 &offsets);
