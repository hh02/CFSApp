...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ImVec2(const Eigen::Vector2d& f) { x = f.x; y = f.y; }                       \
        operator Eigen::Vector2d() const { return Eigen::Vector2d(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const Eigen::Vector4d& f) { x = f.x; y = f.y; z = f.z; w = f.w; }     \
        operator Eigen::Vector4d() const { return Eigen::Vector4d(x,y,z,w); }
